...
--[[
  ...
  -Additionally, ensure that you have the teve_attachments.xml, teve_attachments.js, and teve_attachments.css files in your panorama content folder to use the GUI.
...
function Attachments:start()
  Convars:RegisterCommand( "attachment_configure", Dynamic_Wrap(Attachments, 'ActivateAttachmentSetup'), "Attachment Setup: attachment_configure <ADDON_NAME>  (e.g. attachment_configure teve)", FCVAR_CHEAT )
