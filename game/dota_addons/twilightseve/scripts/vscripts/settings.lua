...
MAX_LEVEL = 300                          -- What level should we let heroes get to?
...
FIXED_RESPAWN_TIME = 60                 -- What time should we use for a fixed respawn timer?  Use -1 to keep the default dota behavior.
